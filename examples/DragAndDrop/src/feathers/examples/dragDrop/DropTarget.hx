...
{
	private static inline var DEFAULT_COLOR:Int = 0x36322e;
	private static inline var HOVER_COLOR:Int = 0x26221e;
	...
	{
		var droppedObject:DisplayObject = cast dragData.getDataForFormat(this._dragFormat);
