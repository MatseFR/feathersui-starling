package feathers.starling.examples.transitionsExplorer;
...
import feathers.starling.controls.ScreenNavigatorItem;
import feathers.starling.controls.StackScreenNavigator;
import feathers.starling.controls.StackScreenNavigatorItem;
import feathers.starling.examples.transitionsExplorer.screens.AllTransitionsScreen;
import feathers.starling.examples.transitionsExplorer.screens.ColorFadeTransitionScreen;
import feathers.starling.examples.transitionsExplorer.screens.FadeTransitionScreen;
import feathers.starling.examples.transitionsExplorer.screens.FourWayTransitionScreen;
import feathers.starling.examples.transitionsExplorer.screens.IrisTransitionScreen;
...
import feathers.starling.motion.Cube;
import feathers.starling.motion.Flip;
