...
import feathers.starling.controls.renderers.IGroupedListFooterRenderer;
import feathers.starling.controls.renderers.IGroupedListHeaderRenderer;
 ...
 */
class LayoutGroupGroupedListHeaderOrFooterRenderer extends LayoutGroup implements IGroupedListHeaderRenderer implements IGroupedListFooterRenderer
{
	/**
