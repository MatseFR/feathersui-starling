...
class ItemRendererLayoutOrder 
{
	 ...
	 * @productversion Feathers 3.0.0
	 */
	public static inline var LABEL_ACCESSORY_ICON:String = "labelAccessoryIcon";
	 ...
	 * @productversion Feathers 3.0.0
	 */
	public static inline var LABEL_ICON_ACCESSORY:String = "labelIconAccessory";
}