...
import feathers.starling.utils.keyboard.KeyToEvent;
 ...
 */
class KeyToTrigger extends KeyToEvent 
{
	/**
	 * Constructor.
	 */
	public function new(target:IFocusDisplayObject = null, keyCode:Int = Keyboard.SPACE) 
	{
