...
class ButtonState 
{
	 ...
	 * @productversion Feathers 3.0.0
	 */
	public static inline var UP_AND_SELECTED:String = "upAndSelected";
	 ...
	 * @productversion Feathers 3.0.0
	 */
	public static inline var DOWN_AND_SELECTED:String = "downAndSelected";
	 ...
	 * @productversion Feathers 3.0.0
	 */
	public static inline var HOVER_AND_SELECTED:String = "hoverAndSelected";
	 ...
	 * @productversion Feathers 3.0.0
	 */
	public static inline var DISABLED_AND_SELECTED:String = "disabledAndSelected";
	 ...
	 */
	public static inline var FOCUSED_AND_SELECTED:String = "focusedAndSelected";
}