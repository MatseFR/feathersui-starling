...
class StepperButtonLayoutMode 
{
	 ...
	 * @productversion Feathers 3.0.0
	 */
	public static inline var SPLIT_HORIZONTAL:String = "splitHorizontal";
	 ...
	 * @productversion Feathers 3.0.0
	 */
	public static inline var SPLIT_VERTICAL:String = "splitVertical";
	 ...
	 * @productversion Feathers 3.0.0
	 */
	public static inline var RIGHT_SIDE_VERTICAL:String = "rightSideVertical";
}